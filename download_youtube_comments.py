...
for channel in channels:
  ...
  with open("videos_%s.csv" % channel["name"], "wb+") as videoFile:
    ...
    videoWriter.writerows([["channelCategory", "channelId", "channelTitle", "videoId", "videoTitle", "videoDesc", "videoPublishedAt"]])
    for video in videos:
      videoWriter.writerows([[channel["category"],
  ...
  with open("comments_%s.csv" % channel["name"], "wb+") as commentFile:
    ...
    commentWriter.writerows([["videoId", "commentId", "author", "text", "replies", "likes", "publishedAt"]])
